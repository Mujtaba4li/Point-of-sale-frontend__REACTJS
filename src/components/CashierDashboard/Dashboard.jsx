...
function ResponsiveDrawer(props) {
  ...
  const drawer = (
    <div>
      ...
      <Link to={`${props.match.path}/add-items`}>
      ...
      <ListItemButton onClick={handleClick2}>
        ...
        <ListItemText primary="Manage Items Categories" />
      ...
      <Link to={`${props.match.path}/item-on-purchase`}>
        <ListItemButton>
          <ListItemIcon>
            <DonorIcon />
          </ListItemIcon>
          <ListItemText primary="Item On Purchase" />
        </ListItemButton>
      </Link>
